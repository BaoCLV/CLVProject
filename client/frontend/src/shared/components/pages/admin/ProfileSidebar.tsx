  ...
  return (
    <aside className="sticky top-0 py-16 w-64 h-screen bg-white shadow-lg flex-shrink-0 flex flex-col">
      ...
      <ul className="mt-4 space-y-2">
        ...
        <li className="relative px-6 py-3">
          <span
            className={`absolute inset-y-0 left-0 w-1 ${pathname === `/admin/route` ? "bg-blue-600" : ""
              } rounded-tr-lg rounded-br-lg`}
            aria-hidden="true"
          ></span>
          <a
            className={`inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 cursor-pointer ${pathname === `/admin/route`
              ? "text-blue-600"
              : "text-gray-800 hover:text-blue-500"
              }`}
        ...
        <li className="relative px-6 py-3">
          <span
            className={`absolute inset-y-0 left-0 w-1 ${pathname === `/admin/userlist` ? "bg-blue-600" : ""
              } rounded-tr-lg rounded-br-lg`}
            aria-hidden="true"
          ></span>
          <a
            className={`inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 cursor-pointer ${pathname === `/admin/userlist`
              ? "text-blue-600"
              : "text-gray-800 hover:text-blue-500"
              }`}
        ...
        <li className="relative px-6 py-3">
          <span
            className={`absolute inset-y-0 left-0 w-1 ${pathname === `/admin/rolelist` ? "bg-blue-600" : ""
              } rounded-tr-lg rounded-br-lg`}
            aria-hidden="true"
          ></span>
          <a
            className={`inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 cursor-pointer ${pathname === `/admin/rolelist`
              ? "text-blue-600"
              : "text-gray-800 hover:text-blue-500"
              }`}
